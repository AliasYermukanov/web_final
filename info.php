      ...
      <div class="container">
        <?php  
          if(isset($_GET['id'])){
                        ...
                        $idsch=$row3['school_id'];
                        $res2 = $conn->query("SELECT * FROM schools where `id` = '$idsch' ");
        ...
        <header class="section-header">
          ...
          <p><?php echo "School name: " .$row2['s_name'].", short info: " . $row2['info'] ." mobile: " . $row2['mobile'] . " e-mail: " . $row2['e-mail'] ;?></p>
          <p><?php echo "Course name:" .$row3['name'] . " type: " . $row3['type'] . " price: " . $row3['price']; ?>
        </header>
